<div class="admin-sidebar" style="width: 260px; background-color: #1040C0; color: white; display: flex; flex-direction: column; padding: 2rem 0; box-shadow: 2px 0 8px rgba(0, 0, 0, 0.1); position: fixed; height: 100vh; overflow-y: auto; left: 0; top: 0; z-index: 100;">
    <div class="admin-sidebar-header" style="padding: 0 1.5rem 2rem; border-bottom: 1px solid rgba(255, 255, 255, 0.2);">
        ...
        <span style="font-size: 12px; color: rgba(255, 255, 255, 0.7); display: block; margin-top: 4px;">Staff Panel</span>
    </div>
    <nav class="admin-sidebar-nav" style="flex: 1; padding: 1rem 0; display: flex; flex-direction: column;">
        <a href="{{ route('staff.dashboard') }}" class="admin-nav-link {{ request()->routeIs('staff.dashboard') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem; padding: 0.875rem 1.5rem; color: rgba(255, 255, 255, 0.9); text-decoration: none; font-weight: 500; border-left: 3px solid {{ request()->routeIs('staff.dashboard') ? 'white' : 'transparent' }}; background-color: {{ request()->routeIs('staff.dashboard') ? 'rgba(255, 255, 255, 0.15)' : 'transparent' }}; transition: all 0.2s;">
        ...
        <a href="{{ route('staff.users.index') }}" class="admin-nav-link {{ request()->routeIs('staff.users.*') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem; padding: 0.875rem 1.5rem; color: rgba(255, 255, 255, 0.9); text-decoration: none; font-weight: 500; border-left: 3px solid {{ request()->routeIs('staff.users.*') ? 'white' : 'transparent' }}; background-color: {{ request()->routeIs('staff.users.*') ? 'rgba(255, 255, 255, 0.15)' : 'transparent' }}; transition: all 0.2s;">
        ...
        <a href="{{ route('staff.skills.index') }}" class="admin-nav-link {{ request()->routeIs('staff.skills.*') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem; padding: 0.875rem 1.5rem; color: rgba(255, 255, 255, 0.9); text-decoration: none; font-weight: 500; border-left: 3px solid {{ request()->routeIs('staff.skills.*') ? 'white' : 'transparent' }}; background-color: {{ request()->routeIs('staff.skills.*') ? 'rgba(255, 255, 255, 0.15)' : 'transparent' }}; transition: all 0.2s;">
        ...
        <a href="{{ route('staff.purchases.index') }}" class="admin-nav-link {{ request()->routeIs('staff.purchases.*') ? 'active' : '' }}" style="display: flex; align-items: center; gap: 0.75rem; padding: 0.875rem 1.5rem; color: rgba(255, 255, 255, 0.9); text-decoration: none; font-weight: 500; border-left: 3px solid {{ request()->routeIs('staff.purchases.*') ? 'white' : 'transparent' }}; background-color: {{ request()->routeIs('staff.purchases.*') ? 'rgba(255, 255, 255, 0.15)' : 'transparent' }}; transition: all 0.2s;">
