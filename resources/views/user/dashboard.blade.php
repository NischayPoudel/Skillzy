        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div style="background: white; border: 2px solid #1040C0; border-radius: 12px; padding: 28px; box-shadow: 0 2px 8px rgba(0,0,0,0.08); margin-bottom: 40px;">
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 12px;">
                    <a href="{{ route('listings.index') }}" style="padding: 12px 24px; background: white; color: #1040C0; border: 2px solid #1040C0; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 14px; cursor: pointer; transition: all 200ms ease-out;" onmouseover="this.style.background='#f8f9fa'; this.style.transform='translateY(-2px)';" onmouseout="this.style.background='white'; this.style.transform='translateY(0)';">Browse Skills</a>
                    <a href="{{ route('user.listings.index') }}" style="padding: 12px 24px; background: white; color: #1040C0; border: 2px solid #1040C0; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 14px; cursor: pointer; transition: all 200ms ease-out;" onmouseover="this.style.background='#f8f9fa'; this.style.transform='translateY(-2px);'" onmouseout="this.style.background='white'; this.style.transform='translateY(0);'">My Listings</a>
                    <a href="{{ route('user.listings.management') }}" style="padding: 12px 24px; background: white; color: #1040C0; border: 2px solid #1040C0; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 14px; cursor: pointer; transition: all 200ms ease-out;" onmouseover="this.style.background='#f8f9fa'; this.style.transform='translateY(-2px);'" onmouseout="this.style.background='white'; this.style.transform='translateY(0);'">Billing & Requests</a>
                    ...
                    <a href="{{ route('messages.index') }}" style="padding: 12px 24px; background: white; color: #1040C0; border: 2px solid #1040C0; border-radius: 6px; text-decoration: none; font-weight: 600; font-size: 14px; cursor: pointer; transition: all 200ms ease-out;" onmouseover="this.style.background='#f8f9fa'; this.style.transform='translateY(-2px);'" onmouseout="this.style.background='white'; this.style.transform='translateY(0);'">Messages</a>
                </div>
            </div>
