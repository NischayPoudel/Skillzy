            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-lg sm:rounded-lg border border-gray-200 dark:border-gray-700">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <a href="{{ route('admin.skills.create') }}" style="display: inline-flex; align-items: center; padding: 10px 16px; background-color: #1040C0; color: white; border-radius: 8px; text-decoration: none; transition: all 200ms ease-out; font-weight: 600;">
                                    ...
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-700 transition duration-150">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                            <div style="display: flex; justify-content: center; gap: 12px;">
                                                <a href="{{ route('admin.skills.edit', $skill) }}" class="btn-edit">
