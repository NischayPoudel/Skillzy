                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.skills.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div style="margin-bottom: 24px;">
                            ...
                            <textarea name="description" id="description" rows="4" placeholder="Enter skill description" required style="width: 100%; padding: 10px 12px; border: 2px solid #333; border-radius: 8px; font-size: 16px; font-family: 'Outfit', sans-serif;">{{ old('description') }}</textarea>
                            @error('description')
                                <p style="color: #D02020; font-size: 13px; margin-top: 4px;">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div style="display: flex; gap: 12px;">
                            <button type="submit" style="flex: 1; padding: 12px 16px; background-color: #1040C0; color: white; border: 2px solid #121212; border-radius: 8px; font-weight: 600; font-size: 14px; cursor: pointer; transition: all 200ms ease-out;">
                                Create Skill
                            </button>
