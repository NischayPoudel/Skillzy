                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{ route('admin.users.update', $user) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div style="margin-bottom: 24px;">
                            ...
                            <input type="password" name="password" id="password" placeholder="Leave blank to keep current password" style="width: 100%; padding: 10px 12px; border: 2px solid #333; border-radius: 8px; font-size: 16px; font-family: 'Outfit', sans-serif;">
                            @error('password')
                                <p style="color: #D02020; font-size: 13px; margin-top: 4px;">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div style="margin-bottom: 24px;">
                            ...
                            <input type="password" name="password_confirmation" id="password_confirmation" placeholder="Confirm new password" style="width: 100%; padding: 10px 12px; border: 2px solid #333; border-radius: 8px; font-size: 16px; font-family: 'Outfit', sans-serif;">
                        </div>
